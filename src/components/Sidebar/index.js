  ...
  return (
    <div className="h-screen w-screen bg-regalblue">
      ...
      <div className="flex flex-col items-center mt-8 w-full">
          <button className="text-white font-medium text-xl mb-8 w-full py-4 hover:bg-" onClick={() => {
              handleSidebar()
          ...
          <button className="text-white font-medium text-xl w-full py-4 hover:bg-pinkPallete" onClick={() => {
              handleSidebar()
              navigate("/login")
              }}>Sign In</button>
        </div>
